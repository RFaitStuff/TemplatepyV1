# =============================================================================
# QUEST DEFINITIONS - register every quest here, organized by category.
# Story code only needs to call set_flag(...) for the relevant checkpoints;
# the manager auto-progresses and completes them.
# =============================================================================
