...
init -2 python:
    ...
    register_location("hallway",   name="Hallway",   bg="smp_hallway", area="school", variants={"alice": [""], "bree": [""], "cora": [""]})
    ...
    register_location("archive_room", name="Records Archive", bg="smp_classroom4", area="school", order_after="club_room", variants={"alice": [""], "bree": [""], "cora": [""]}, unlocked=False)

    # Outdoors
    register_location("front",     name="School Front", bg="smp_front", area="outdoors", variants={"alice": [""], "alex": [""], "cora": [""]})
