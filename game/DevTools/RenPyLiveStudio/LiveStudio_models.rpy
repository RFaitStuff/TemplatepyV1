    ...
    def new_project(name="Untitled Live Studio Project"):
        ...
        return {
            ...
            "project": {
                ...
                "entry_frame_id": None,
                "live_studio_version": RELEASE_VERSION,
                "project_model_version": VERSION,
                "engine_version": None,
                "project_path": None,
                "last_exported_revision": 0,
                "current_editing_session": None,
            ...
            "settings": {
                ...
                "coordinate_mode_default": "auto",
                "diagnostics_compatibility_fallbacks": False,
            },
        }
